...
@section('title', 'เพิ่มวิดีโอวิสัยทัศน์ - ' . $school->name)
...
@section('stylesheet-content')
    ...
    <style>
        ...
        .video-type-badge.tiktok {
            background: #000000;
            color: white;
        }

        .video-type-badge.other {
            background: #6c757d;
            color: white;
        }
    ...
    <div class="innovation-form-container">
        <div class="container">
            ...
            <div class="form-card">
                ...
                <form action="{{ route('sandbox.schools.vision-videos.store', $school->id) }}" method="POST"
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('video_type') is-invalid @enderror" id="video_type"
                                    ...
                                    <option value="facebook" {{ old('video_type') == 'facebook' ? 'selected' : '' }}>
                                        Facebook
                                    </option>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="4" placeholder="คำอธิบายเกี่ยวกับวิดีโอวิสัยทัศน์นี้...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div id="videoPreview" class="video-preview">
                        <h4 style="margin-bottom: 1rem;">
                            <i class="fas fa-eye"></i> ตัวอย่างวิดีโอ
                        </h4>
...
@section('script-content')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // URL examples for different video types
            const urlExamples = {
            ...
            // Function to update URL example display
            ...
            // Update URL example when video type changes
            videoTypeSelect.addEventListener('change', function() {
                updateUrlExample(this.value);
            });

            // Initialize with current value (for old() values)

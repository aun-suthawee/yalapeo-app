...
@section('title', 'เพิ่มโรงเรียนใหม่')
    ...
    <div class="school-form-container">
        <div class="container">
            ...
            <div class="page-header">
                <h1 class="page-title">เพิ่มโรงเรียนใหม่</h1>
            ...
            <!-- Form Card -->
            <div class="form-card">
                <form action="{{ route('sandbox.schools.store') }}" method="POST" id="schoolForm">
                    @csrf
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="school_code" name="school_code"
                                    class="form-control @error('school_code') is-invalid @enderror" value="{{ old('school_code') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name"
                                    ...
                                    placeholder="เช่น โรงเรียนอิสลาฮุดดีนวิทยา" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select id="school_type" name="school_type"
                                    ...
                                    <option value="ขนาดเล็ก" {{ old('school_type') == 'ขนาดเล็ก' ? 'selected' : '' }}>ขนาดเล็ก (นักเรียนไม่เกิน 120 คน)</option>
                                    <option value="ขนาดกลาง" {{ old('school_type') == 'ขนาดกลาง' ? 'selected' : '' }}>ขนาดกลาง (121-600 คน)</option>
                                    <option value="ขนาดใหญ่" {{ old('school_type') == 'ขนาดใหญ่' ? 'selected' : '' }}>ขนาดใหญ่ (601-1,500 คน)</option>
                                    <option value="ขนาดใหญ่พิเศษ" {{ old('school_type') == 'ขนาดใหญ่พิเศษ' ? 'selected' : '' }}>ขนาดใหญ่พิเศษ (มากกว่า 1,500 คน)</option>
                                </select>
                                @error('school_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select id="ministry_affiliation" name="ministry_affiliation"
                                    ...
                                    <option value="กระทรวงศึกษาธิการ" {{ old('ministry_affiliation') == 'กระทรวงศึกษาธิการ' ? 'selected' : '' }}>กระทรวงศึกษาธิการ</option>
                                    <option value="สำนักงานคณะกรรมการส่งเสริมการศึกษาเอกชน" {{ old('ministry_affiliation') == 'สำนักงานคณะกรรมการส่งเสริมการศึกษาเอกชน' ? 'selected' : '' }}>สำนักงานคณะกรรมการส่งเสริมการศึกษาเอกชน</option>
                                    <option value="กระทรวงมหาดไทย" {{ old('ministry_affiliation') == 'กระทรวงมหาดไทย' ? 'selected' : '' }}>กระทรวงมหาดไทย</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="bureau_affiliation" name="bureau_affiliation"
                                    ...
                                    <option value="สำนักงานคณะกรรมการการศึกษาขั้นพื้นฐาน (สพฐ.)" {{ old('bureau_affiliation') == 'สำนักงานคณะกรรมการการศึกษาขั้นพื้นฐาน (สพฐ.)' ? 'selected' : '' }}>สำนักงานคณะกรรมการการศึกษาขั้นพื้นฐาน (สพฐ.)</option>
                                    <option value="สำนักงานการศึกษาเอกชนจังหวัดยะลา" {{ old('bureau_affiliation') == 'สำนักงานการศึกษาเอกชนจังหวัดยะลา' ? 'selected' : '' }}>สำนักงานการศึกษาเอกชนจังหวัดยะลา</option>
                                    <option value="กรมส่งเสริมการปกครองท้องถิ่น" {{ old('bureau_affiliation') == 'กรมส่งเสริมการปกครองท้องถิ่น' ? 'selected' : '' }}>กรมส่งเสริมการปกครองท้องถิ่น</option>
                                    <option value="องค์การบริหารส่วนจังหวัดยะลา" {{ old('bureau_affiliation') == 'องค์การบริหารส่วนจังหวัดยะลา' ? 'selected' : '' }}>องค์การบริหารส่วนจังหวัดยะลา</option>
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="male_students" name="male_students"
                                    ...
                                    value="{{ old('male_students', 0) }}" min="0" required>
                                @error('male_students')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="female_students" name="female_students"
                                    ...
                                    value="{{ old('female_students', 0) }}" min="0" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="total_students" class="form-control" readonly placeholder="0">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="male_teachers" name="male_teachers"
                                    ...
                                    value="{{ old('male_teachers', 0) }}" min="0" required>
                                @error('male_teachers')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="female_teachers" name="female_teachers"
                                    ...
                                    value="{{ old('female_teachers', 0) }}" min="0" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="total_teachers" class="form-control" readonly placeholder="0">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="address" name="address" class="form-control @error('address') is-invalid @enderror" rows="3"
                                placeholder="ที่อยู่ของโรงเรียน">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

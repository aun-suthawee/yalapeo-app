                    ...
                    <div class="tile-body">
                        <div class="form-row">
                            <div class="form-group col-md-7">
                                <label>ที่อยู่วิดิโอ <span class="badge badge-danger">YouTube</span> <span
                                        class="badge badge-primary">Facebook</span></label>
                                <input type="text" class="form-control @error('url') is-invalid @enderror" name="url"
                                    value="{{ old('url') }}"
                                    placeholder="ex. https://www.youtube.com/watch?v=6Oo5trPKpOo">

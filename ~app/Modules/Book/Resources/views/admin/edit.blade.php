...
@section('app-content')
		<div class="row justify-content-center">
				<div class="col-11">
						...
						<form action="{{ route('admin.book.update', $result->id) }}" method="POST" enctype="multipart/form-data">
								@csrf
								{{ method_field('PUT') }}
								<div class="tile">
										...
										<div class="tile-body">
												<div class="form-row">
														<div class="form-group col-md-6">
																...
																<input type="text" class="form-control" name="title" value="{{ $result->title }}" placeholder="ระบุชื่อหนังสือ">
														</div>
														<div class="form-group col-md-6">
																<label>หน้าปก</label>
																<input type="file" name="cover" class="form-control @error('cover') is-invalid @enderror krajee-input" data-msg-placeholder="เลือกไฟล์หน้าปก" accept="image/*" data-initial-caption="{{ $result->cover }}">
																<small class="form-text text-muted">ขนาดรูปภาพที่เหมาะสม 208 x 302 pixel (กว้าง x สูง)</small>

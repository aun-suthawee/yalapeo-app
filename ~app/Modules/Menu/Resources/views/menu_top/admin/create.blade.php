...
@section('app-content')
		<div class="row justify-content-center">
				<div class="col-11">
						<form action="{{ route('admin.menu-top.store') }}" method="POST" enctype="multipart/form-data">
								@csrf
								<div class="tile">
										...
										<div class="tile-body">
												<div class="form-row">
														<div class="form-group col-md-6">
																...
																<input type="text" class="form-control" name="name" placeholder="ระบุชื่อเมนู">
														</div>
														<div class="form-group col-md-6">
												...
												<div class="form-row">
														<div class="form-group col-md-8">
																...
																<input type="text" class="form-control" name="url" placeholder="ระบุลิงค์เชื่อมโยง">
														</div>

...
@section('app-content')
		<div class="tile">
				<div class="tile-title-w-btn">
						...
						<p>
								<a class="btn btn-primary icon-btn" href="{{ route('admin.menu-side.create') }}"><i class="fa fa-plus-circle fa-fw"></i>สร้าง
								</a>
				...
				<div class="tile-body">
						<div class="table-responsive">
								<table class="table-hover table-sm m-0 table">
										<tbody class="sortable" data-href="{{ route('admin.menu-side.sort') }}">
																				...
																				<tr>
																						...
																						<td width="1">
																								<div class="option-link">
																										<form method="POST" action="{{ route('admin.menu-side.destroy', $level1->id) }}">
																												@csrf
																												{{ method_field('DELETE') }}
																												<a class="btn btn-sm btn-info" href="{{ route('admin.menu-side.edit', [$level1->id]) }}">
																														แก้ไข</a>
																				...
																				@if (isset($level1->children) && count($level1->children))
																						<tr>
																								...
																								<td colspan="2" class="p-0">
																										<table class="table-sm table-hover m-0 table">
																												<tbody class="group_items" data-href="{{ route('admin.menu-side.sort') }}">
																																		...
																																		<td class="p-0">
																																				<table class="table-sm table-hover m-0 table">
																																						<tr>
																																								...
																																								<td width="1">
																																										<div class="option-link">
																																												<form method="POST" action="{{ route('admin.menu-side.destroy', $level2->id) }}">
																																														@csrf
																																														{{ method_field('DELETE') }}
																																														<a class="btn btn-sm btn-info" href="{{ route('admin.menu-side.edit', [$level2->id]) }}">
																																																แก้ไข</a>
																																														<button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('ท่านต้องการลบรายการนี้ใช่หรือไม่ ?')">
																																																ยกเลิก
																																														</button>
																																																				...
																																																				<td class="p-0">
																																																						<table class="table-sm table-hover m-0 table">
																																																								<tr>
																																																										...
																																																										<td width="1">
																																																												<div class="option-link">
																																																														<form method="POST" action="{{ route('admin.menu-side.destroy', $level3->id) }}">
																																																																@csrf
																																																																{{ method_field('DELETE') }}
																																																																<a class="btn btn-sm btn-info" href="{{ route('admin.menu-side.edit', [$level3->id]) }}">
																																																																		แก้ไข</a>
																																																																<button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('ท่านต้องการลบรายการนี้ใช่หรือไม่ ?')">
																																																																		ยกเลิก
																																																																</button>

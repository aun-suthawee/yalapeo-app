...
namespace Modules\TiktokVideo\Providers;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\TiktokVideo\Http\Controllers';
    ...
    protected function mapApiRoutes()
    {
        if (!$this->isSubdomain(request()->getHost())) {
            Route::prefix('api')
                ...
                ->group(module_path('TiktokVideo', '/Routes/api.php'));
        }
    }
    ...
    protected function mapWebRoutes()
    {
        if (!$this->isSubdomain(request()->getHost())) {
            Route::middleware('web')
                ->namespace($this->moduleNamespace)
                ->group(module_path('TiktokVideo', '/Routes/web.php'));
        }
    }

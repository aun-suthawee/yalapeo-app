...
CKEDITOR.plugins.add('bootstrapTabs', {
  ...
  init: function (editor) {
    ...
    editor.addCommand('bootstrapTabs', new CKEDITOR.dialogCommand('bootstrapTabsDialog', {
      ...
      // fot Bootstrap 5
      allowedContent: 'button div ul li a[role,href,id,data-bs-*](bootstrap-tabs,nav,nav-tabs,tab-link,active,tab-content,tab-pane,tab-pane-content,nav-link,nav-item,pill)'
    }));
